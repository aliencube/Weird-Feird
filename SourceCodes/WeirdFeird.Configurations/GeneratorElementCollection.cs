...
{
    /// <summary>
    /// This represents the entity containing the collection of generator element groups.
    /// </summary>
    public class GeneratorElementCollection : ConfigurationElementCollection
    {
        #region Properties
        ...
        public GeneratorElement this[int index]
        {
            get { return (GeneratorElement)this.BaseGet(index); }
            set
            {
        ...
        public new GeneratorElement this[string key]
        {
            get { return (GeneratorElement)this.BaseGet(key); }
            set
            {
                var item = (GeneratorElement)this.BaseGet(key);
                if (item != null)
                {
        ...
        {
            return ((GeneratorElement)element).Key;
        }
